...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ mod, shift }, "w", function()
    awful.spawn(apps.default.firejail .. " " .. apps.default.web_browser1)
  end, { description = "open " .. apps.default.web_browser1, group = "app" }),

  awful.key({ ctrl, alt }, "f", function()
    awful.spawn(apps.default.firejail .. " " .. apps.default.web_browser1)
  end, { description = "open " .. apps.default.web_browser1, group = "app" }),

  awful.key({ ctrl, alt }, "b", function()
    awful.spawn(apps.default.firejail .. " " .. apps.default.web_browser2)
  end, { description = "open " .. apps.default.web_browser2, group = "app" }),

  awful.key({ ctrl, alt }, "t", function()
    awful.spawn(apps.default.web_browser3)
  end, { description = "open " .. apps.default.web_browser3, group = "app" }),
  ...
  --File manager
	awful.key({ ctrl, alt }, "x", function()
		awful.spawn.easy_async_with_shell(apps.utils.xplr, function() end)
	end, { description = "open file manager", group = "hotkeys" }),
