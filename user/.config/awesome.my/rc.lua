...
local imageeditor    = "krita"
local editor_cmd     = string.format("%s/.config/awesome/scripts/%s.sh", os.getenv("HOME"), editor)
-- local editor_cmd     = string.format("%s/.config/awesome/scripts/editor_cmd.sh", os.getenv("HOME"))
...
-- {{{ Personal keybindings
  awful.key({ modkey }, "w", function() awful.util.spawn(firejail .. " " .. browser1) end,
  ...
  -- super + ... function keys
  awful.key({ modkey }, "F1", function() awful.util.spawn(firejail .. " " .. browser1) end,
    { description = browser1, group = "function keys" }),
  awful.key({ modkey }, "F2", function() awful.util.spawn(editor_cmd) end,
  ...
  awful.key({ modkey }, "F4", function() awful.util.spawn(imageeditor) end,
    { description = imageeditor, group = "function keys" }),
  ...
  awful.key({ modkey }, "x", function() awful.util.spawn(string.format("%s/.config/awesome/scripts/powermenu.sh", os.getenv("HOME"))) end,
    { description = "exit", group = "hotkeys" }),
  ...
  awful.key({ modkey1, altkey }, "f", function() awful.util.spawn(firejail .. " " .. browser2) end,
  ...
  awful.key({ modkey1, altkey }, "r", function() awful.util.spawn(string.format("%s/.config/awesome/scripts/ranger.sh", os.getenv("HOME"))) end,
    { description = mediaplayer, group = "alt+ctrl" }),
  awful.key({ modkey1, altkey }, "s", function() awful.util.spawn(mediaplayer) end,
    { description = mediaplayer, group = "alt+ctrl" }),
  awful.key({ modkey1, altkey }, "t", function() awful.util.spawn(browser3) end,
  ...
  awful.key({ modkey1, altkey }, "v", function() awful.util.spawn(firejail .. " " .. browser1) end,
...
awful.rules.rules = {
  ...
  { rule = { class = "krita", role = "krita-image-window" },
    properties = { maximized = true } },
